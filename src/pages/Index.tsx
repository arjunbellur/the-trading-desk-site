        ...
        <div className="absolute inset-0 pointer-events-none z-10">
          <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 right-0 z-[100] h-0.5 bg-emerald-600 origin-center"
            />
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 right-0 translate-y-px z-[101] h-px bg-emerald-300 origin-center"
            />
